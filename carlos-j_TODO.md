...
- there will be a feature to report a player/room/draw, but who will it report to? email to the admin? since we won't save any details of the rooms/drawings besides the final points and winners, how can we "save" a report of a drawing? send a snapshot of the drawing on the moment of report? what will it be used for? will we have an admin profile with previleges to edit/delete users?
