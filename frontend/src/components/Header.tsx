...
// Traço ondulado desenhado à mão (o mesmo estilo do risco do hover).
const WAVY_D =
  'M2,6 C15,1 20,10 30,6 C40,2 45,9 55,5 C65,1 70,9 80,5 C88,2 92,7 98,5'

// Botão desenhado do Login/Perfil (Uiverse type--C recolorido: contorno
// branco, rabisco laranja marcado no hover; ícone em vez de texto).
function DrawButton({
  to,
  label,
  children,
...
// O bonequinho do projeto (a mesma silhueta dos cartões da equipa/About us).
const PERSON_D =
...
// Risco de marcador que se desenha por cima do link no hover (Uiverse,
// recolorido para o vermelho do projeto — a cor do antigo traço de baixo).
const HIGHLIGHT_D =
