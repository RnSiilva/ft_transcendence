...
// Página About us: o computador desenhado como identidade, o texto de
// apresentação e 3 cartões numerados (Uiverse adaptado às cores do projeto).
...
function About() {
  ...
  return (
    <main className="about-page">
      ...
      {/* computador desenhado — assinatura de fecho, como na Home */}
